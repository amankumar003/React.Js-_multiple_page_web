/* AgentDetailsAdd.js - AgentDetailsAdd component for the FOOTFALL */
...
/*
DESCRIPTION
This file is the AgentDetailsAdd component for FOOTFALL.
*/
...
class AgentDetailsAdd extends React.Component {
	constructor(props) {
		super(props);
		let name = "";
		let email = "";
...
export default (AgentDetailsAdd)
