/* RaffleFeedBackAddView.js - RaffleFeedBackAddView component for the FOOTFALL */
...
--------------------
01a,30jan23,pwn  created.
*/

/*
DESCRIPTION
This file is the RaffleFeedBackAddView component for FOOTFALL.
*/
...
class QRCode extends React.Component {
    ...
    */
    ...
    footerUI() {
        let userDt = this.props.raffleDt[0].openHouseId.userId.profile;
        let personName = userDt.name === null ? "" : userDt.name;
        let userId = this.props.raffleDt[0].openHouseId.userId.id;
    ...
    render() {
        let cardDt = this.props.raffleDt[0].rafflecardSet[0];

        let cardTitle = cardDt.cardBrandName;
        let cardWinAmount = cardDt.cardGiftValue;
                ...
                {this.state.showFeedBackAdd === false &&
                    <div style={{
                        ...
                        <div style={{
                            ...
                            height: this.state.height <= 800 ? "65vh" : "73vh",
                            marginBottom: "0.5rem"
                            ...
                            <div style={{
                                ...
                                <font style={{
                                    ...
                                    Share feedback to win Raffle
                                </font>
                                <CustomQRCode
                                    size={this.state.height <= 800 ? 160 : 180}
                                    url={"https://footfallz.com/feedBackAdd/" + this.state.openHouseId} />
                                <font style={{
                                    textAlign: "center",
                                    fontWeight: "400",
                                    color: "black",
